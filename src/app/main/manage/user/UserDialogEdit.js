...
class UserDialogEdit extends Component {
...
const mapStateToProps = (state) => {
    return {
        ...
        errorMsg: state.user.user.error
    }
}
...
UserDialogEdit.contextType = AppContext;

export default connect(mapStateToProps, mapDispatchToProps)(React.memo(UserDialogEdit));